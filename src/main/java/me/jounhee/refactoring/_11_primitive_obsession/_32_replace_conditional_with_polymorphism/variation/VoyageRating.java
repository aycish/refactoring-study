package me.jounhee.refactoring._11_primitive_obsession._32_replace_conditional_with_polymorphism.variation;
...
public class VoyageRating {
    ...
    private int voyageProfitFactor() {
        ...
        return voyageAndHistoryLength();
    }

    private int voyageAndHistoryLength() {
        int result = 0;
